...
Intro
-----
F1coin is a free open source peer-to-peer electronic cash system that is
...
Setup
-----
Unpack the files into a directory and run f1coin-qt.exe.

If you have Microsoft Security Essentials, you need to add litecoin-qt.exe to its
"Excluded processes" list.  Microsoft Security Essentials->Settings tab,
select Excluded processes, press Add, select f1coin-qt.exe, OK, Save changes.
