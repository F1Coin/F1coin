...
Alternatively, install `Qt Creator`_ and open the `f1coin-qt.pro` file.

An executable named `f1coin-qt` will be built.
...
A warning for people using the *static binary* version of F1coin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).
