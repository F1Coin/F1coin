...
// Copyright (c) 2017 F1coin Developers
...
uint256 hashGenesisBlock("0xb640fb4d0621c762295a42e3f9b28247d0c0454bc71674c515f3cdc2cc934597");
...
const string strMessageMagic = "F1Coin Signed Message:\n";
...
static const int64 nTargetTimespan = 12 * 60 * 60; // F1Coin: 12 hours
static const int64 nTargetSpacing = 60; // F1Coin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal f1coin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "F1Coin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1520827115; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 329521;

        if (fTestNet)
        {
            block.nTime    = 1358378400;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc6d4ca21d729239f02ddddf6af303b0ed69fe2880b337fc690ba58fb80d6b173"));
